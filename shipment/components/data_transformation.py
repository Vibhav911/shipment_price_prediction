...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> object:
        ...
        try:
            ...
            onehot_colulmns = self.data_transformation_config.SCHEMA_CONFIG['onehot_columns']
            ...
            logging.info("Intialized StandardScaler, OneHotEncoder, BinaryEncoder")
            
            # Using transformer objects in column transformer
            preprocessor = ColumnTransformer(
                [
                    ("OneHotEncoder", oh_transformer, onehot_colulmns),
