...
class shippingData:
    ...
    def get_data(self) -> Dict:
        ...
        try:
            ...
            logging.info("Exited get_data method of shippigData class")
            return input_data
    ...
    def get_input_data_frame(self) -> DataFrame:
        ...
        Output      :    DataFrame 
        """ 
        logging.info("Entered get_input_data_frmae method of class")
        try:
...
class CostPredictor:
    ...
    def predict(self, X) -> float:
        ...
        try:
            ...
            best_model = self.s3.load_model(self.bucket_name , MODEL_FILE_NAME)
