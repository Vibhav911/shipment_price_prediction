...
class ModelPusher:
    def __init__(
        ...
        self.model_trainer_artfacts = model_trainer_artifacts
        self.data_transformatio_artifacts = data_transformation_artifacts
        self.s3 = s3
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifacts:
        ...
        try:
            ...
            self.s3.upload_file(
                self.model_trainer_artfacts.trained_model_file_path,
