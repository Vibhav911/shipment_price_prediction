...
import os
import pandas as pd
from pandas.core.series import Index
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, df:DataFrame) -> Tuple[DataFrame, DataFrame]:
        ...
        try:
            # Creating Data Ingesion Artifacts directory inside Artifacts folder
            ...
            # Creating test directories under data ingestion artifact directory
    ...
    # This method intiates data ingestion
