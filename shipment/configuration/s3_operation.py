...
class S3Operation:
    ...
    def get_file_object(self, filename:str, bucket_name: str) -> Union[List[object], object]:
        ...
        Description :   This ethod gets the file object from bucket_name bucket based on filename         
        Output      :   list of objects or object is returned based on filename
        """
     
        logging.info("Entered the get_file_method of S3Operation class")
        try:
            bucket = self.get_bucket(bucket_name)
    ...
    def create_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        try:
            ...
            if e.response['Error']['Code'] == '404':
                ...
                pass
            logging.info("Exited the create_foolder method of S3Operation class")
    ...
    def upload_file(
        ...
        try:
            ...
            if remove is True:
                ...
                logging.info(f"Remove is set to {remove}, delete the file")
            else:
    ...
    def upload_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        logging.info("Entered the upload_folder mothod of S3Operation class")
        try:
    ...
    def upload_df_as_csv(
        ...
        try:
            data_frame.to_csv(local_filename, index=None, header=Ture)
            self.upload_file(local_filename, bucket_filename, bucket_name)
            logging.info("Exited the upload_df_as_csv method of S3Operation class")
    ...
    def get_df_from_object(self, object_:object) -> DataFrame:
        ...
        Output      :   Folder is created in s3 bucket
        """
        logging.info("Entered the get_df_from_method of S3Operation class")
        
        try:
            content = self.read_object(object_, make_readable=True)
            df = read_csv(content, na_values="na")
            logging.info("Exited the get_df_from_object method of S3Uperation class")
            return df
